...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dealer.dealergroup'
        db.add_column(u'reports_dealer', 'dealergroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Dealer Group', null=True, to=orm['reports.DealerGroup']),
                      keep_default=False)

        # Adding field 'DealerGroup.dealergroupcontactname'
        db.add_column(u'reports_dealergroup', 'dealergroupcontactname',
                      self.gf('django.db.models.fields.CharField')(max_length=70, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DealerGroup.dataiumclientid'
        db.add_column(u'reports_dealergroup', 'dataiumclientid',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dealer.dealergroup'
        db.delete_column(u'reports_dealer', 'dealergroup_id')

        # Deleting field 'DealerGroup.dealergroupcontactname'
        db.delete_column(u'reports_dealergroup', 'dealergroupcontactname')

        # Deleting field 'DealerGroup.dataiumclientid'
        db.delete_column(u'reports_dealergroup', 'dataiumclientid')
    ...
    models = {
        ...
        u'reports.dealergroup': {
            ...
            'dealergroupcity': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            'dealergroupstate': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
