...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MarketReportYearMonth.marketreportyearmonthdesc'
        db.delete_column(u'reports_marketreportyearmonth', 'marketreportyearmonthdesc')

        # Adding unique constraint on 'MarketReportYearMonth', fields ['marketreportyearmonthchar']
        db.create_unique(u'reports_marketreportyearmonth', ['marketreportyearmonthchar'])


    def backwards(self, orm):
        # Removing unique constraint on 'MarketReportYearMonth', fields ['marketreportyearmonthchar']
        db.delete_unique(u'reports_marketreportyearmonth', ['marketreportyearmonthchar'])

        # Adding field 'MarketReportYearMonth.marketreportyearmonthdesc'
        db.add_column(u'reports_marketreportyearmonth', 'marketreportyearmonthdesc',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=16, null=True),
                      keep_default=False)
