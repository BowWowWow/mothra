...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DealerDailyHitList.dataiumsiteid'
        db.add_column(u'reports_dealerdailyhitlist', 'dataiumsiteid',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DealerDailyHitList.dataiumsiteid'
        db.delete_column(u'reports_dealerdailyhitlist', 'dataiumsiteid')
