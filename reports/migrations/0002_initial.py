...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reports_dealer', (
            ...
            ('dealerlat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6)),
            ('dealerlong', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6)),
            ('dealerinactive', self.gf('django.db.models.fields.CharField')(default='N', max_length=3, null=True)),
