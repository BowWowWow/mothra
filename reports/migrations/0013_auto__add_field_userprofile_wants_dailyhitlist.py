...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.wants_dailyhitlist'
        db.add_column(u'reports_userprofile', 'wants_dailyhitlist',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.wants_dailyhitlist'
        db.delete_column(u'reports_userprofile', 'wants_dailyhitlist')
